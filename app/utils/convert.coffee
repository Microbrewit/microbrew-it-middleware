...
exports.convert = (amount, from, to) ->
	...
	if typeof from is 'string' and typeof to is 'string' and conversionFormulas[from]?[to]?
		convertedValue = conversionFormulas[from][to](amount)
...
exports.available = (from) ->
	return Object.keys(conversionFormulas[from])
